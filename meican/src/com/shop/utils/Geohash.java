...
//    }
    ...
    public static void main(String[] args) {
        double[] latlon = new Geohash().decode("wx4eysjh");
        System.out.println(latlon[0] + " " + latlon[1]);
 
        Geohash e = new Geohash();
        String s = e.encode(45.81704700,126.55950900);
        System.out.println(s);
        latlon = e.decode(s);
        DecimalFormat df = new DecimalFormat("000.00000");
        System.out.println(df.format(latlon[0]) + ", " + df.format(latlon[1]));
        
        double d=Distance.GetDistance(126.55950900,45.81704700, 126.56506400,45.81578940);
