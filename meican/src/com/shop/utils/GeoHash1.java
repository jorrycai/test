...
import com.shop.utils.LocationBean;  
...
public class GeoHash1 {
    ...
    //(经，纬)  
    public GeoHash1(double lat, double lng) {  
        location = new LocationBean(lng, lat);  
        setMinLatLng();  
    }  
    ...
    //	"lng": 116.30815063007,
      //  "lat": 40.056890127931
    	//得到某个经纬度的编码   116.409981,23.307671
   
    	GeoHash1 g = new GeoHash1(45.8157,126.559); 
        System.out.println("g-----"+g.getGeoHashBase32());  
        //System.out.println(JsonUtil.parseJson(g.getGeoHashBase32For9())); 
        
        //八个区域对应的GeoHash编码
        System.out.println(g.getGeoHashBase32For9());
        
        GeoHash1 g1 = new GeoHash1(45.8157,126.560); 
        System.out.println("g1-----"+g1.getGeoHashBase32()); 
        System.out.println(g1.getGeoHashBase32For9());
